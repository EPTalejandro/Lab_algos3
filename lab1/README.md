...
| Subgrafo                |       O(n)         | Verificar si el grafo contiene los n vértices indicados O(n), para cada vértice en la lista dada, a lo sumo n, se revisa si cada elemento de la mutableList, igual a lo sumo n, está en la lista dada, el tiempo es O($$n^3$$) |
